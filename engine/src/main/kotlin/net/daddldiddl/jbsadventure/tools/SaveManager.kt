...
object SaveManager {
    ...
    fun save(gameData: GameData, currentRoom: Room) {
        ...
        ILogger.current.debug("Saving game state: currentRoomId=${state.currentRoomId}, number of itemSaveStates=${state.itemStates.size}, stateValues=${state.stateValues}")
    ...
    fun load(gameData: GameData): SaveState? {
        ...
        ILogger.current.info("Loaded game state: currentRoomId=${state.currentRoomId}, number of itemSaveStates=${state.itemStates.size}, stateValues=${state.stateValues}")
        return state
    }
