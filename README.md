# JBsAdventureEngine
This is just a small fun project for learning Kotlin - its simplistic, but you can actually create adventures by simply creating a json file (documentation is included in the repo).
