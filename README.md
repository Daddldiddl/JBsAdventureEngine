...
### Regarding AI use
I used Copilot to setup the base project (I can't be arsed to write a pom.xml, sorry!), as well using as AI-based code-completion and debug support throughout the development and for refactoring. Also the guides were AI generated. The rest is my own stupidity, of which there is plenty to go around.
